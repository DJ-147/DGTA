...
count <- readRDS("/public/home/jinyansong/DGTA/data/human40k/count.list.rds")
label <- readRDS("/public/home/jinyansong/DGTA/data/human40k/label.list.rds")
...
fix_index("/public/home/jinyansong/DGTA/data/human40k/input")

acc_intra_graph1("/public/home/jinyansong/DGTA/data/human40k/input") # Accuracy of the intra-datasets graph connections in reference data.

filter4_weight_linux("/public/home/jinyansong/DGTA/data/human40k/input") # filter
